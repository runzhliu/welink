...
export const SettingsPage: React.FC<SettingsPageProps> = ({
  ...
  return (
    <div className="lg:flex lg:gap-6" ref={settingsRootRef}>
      ...
      {/* ── 屏幕锁定 ── */}
      <section className="mb-8" data-settings-tags="屏幕锁 锁屏 lock pin 密码 自动锁">
        <div className="flex items-center gap-2 mb-3">
      ...
      {/* ── 配置重置 / 导出 / 导入 ── */}
      <section className="mb-8" data-settings-tags="重置 reset 导出 export 导入 import 配置 preferences 迁移">
        <div className="flex items-center gap-2 mb-3">
          <Settings size={18} className="text-[#07c160]" />
