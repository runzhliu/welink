...
侧边栏「实验室」Tab，集合了一组**好玩、能分享**的小工具。和"分析"路线不同，这一组以"卡片化、可截图、像 Spotify Wrapped 一样" 为目标。v0.2.0 一次开 5 个，到 v0.3.x 已累计 **17 个**（聊天 DNA / 高光瞬间 / 灵魂提问 / 平行宇宙 / 关系星图 / 群金句榜 / 语言进化史 / 聊天地图 / 人情债 / 断联预警 / 群聊 Wrapped / 反向语义搜索 / AI 虚拟群聊 / 群语料 ROI / 关系考古 / 健康日记 / 暧昧探测）—— 详见 [docs/labs.md](docs/labs.md)。会调 LLM 的 Lab 在 tab 上带紫色 **AI** 标。
