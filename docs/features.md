...
<div class="feat-card"><div class="icon">🧪</div><h4><a href="./labs">创意实验室（22 个 Lab）</a></h4><p>聊天 DNA / 高光瞬间 / 灵魂提问 / 平行宇宙 / 关系星图 / 群金句榜 / 语言进化史 / 聊天地图 / 人情债 / 断联预警 / 关系考古 / 健康日记 / 暧昧探测 / 回复速度榜 / 主动指数榜 / 社交圈流动榜 / 话题图谱 / 语音通话档案 …… 像 Spotify Wrapped 一键分享。</p></div>
...
<div class="feat-card"><div class="icon">📞</div><h4><a href="./labs#_22-语音-通话档案（v0-3-x-新增）">语音 / 通话档案</a></h4><p>把私聊里被忽略的语音条（type 34）+ 音视频通话（type 50）翻出来：煲电话粥榜 / 最长一次通话 / 语音条之王，外加你这些年总通话时长与接通率。只读时长不读内容，零 LLM。</p></div>
